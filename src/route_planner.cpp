...
// Take the current (final) node as an argument and iteratively follow the chain of parents of nodes until the starting node is found.
// For each node in the chain, add the distance from the node to its parent to the distance variable.
// The returned vector is in the correct order: the start node should be the first element of the vector, the end node should be the last element.
